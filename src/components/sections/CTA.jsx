    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: '300px',
          borderRadius: '50%',
          background: 'rgba(15,191,207,0.07)',
          filter: 'blur(60px)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          Join over 50,000 happy customers who've made laundry the easiest part
          of their week.
        </p>
        <Button variant="aqua" style={{ fontSize: '1rem', fontWeight: 600 }}>
